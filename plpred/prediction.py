...
def run_model (file_path:str, model_path:str) -> pd.DataFrame:
    """
    Run a membrane protein prediction on FASTA file
...
def main():
    argument_parser = argparse.ArgumentParser(description='plpred-predict: subcelullar location prediction program')
